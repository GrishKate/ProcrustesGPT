...
class CompressedOPTDecoderLayer(OPTDecoderLayer):
    ...
    def forward(
            ...
            layer_head_mask=None,  #: Tensor | None = None,
        ...
        if self.attn_shortcut_Q is not None:
            rotated_shortcut = residual @ self.attn_shortcut_Q
        ...
        if self.mlp_shortcut_Q is not None:
            rotated_shortcut = residual @ self.mlp_shortcut_Q
...
class OPTModelAdapter(ModelAdapter):
    ...
    def get_embeddings(self) -> list:  # -> list[Module]:
