...
def slice_embeddings(model_adapter: ModelAdapter, new_embedding_dimensions: dict) -> None:
...
def slice_rotated_model(model_adapter: ModelAdapter, slicing_scheduler = None) -> None:
    """
    TODO: Make this gpu memory efficient.
    """
    model_adapter.model.eval()
